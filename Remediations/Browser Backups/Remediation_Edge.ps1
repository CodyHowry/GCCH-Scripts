#setting variables for edge versions
$EdgeStable="Edge"
$EdgeBeta="Edge Beta"
$EdgeDev="Edge Dev"
...
$HTML_File_Dir = "$env:USERPROFILE\OneDrive - JMAres GOV Cloud\Documents\Browser Favorites Backups\"

#filename of HTML-Export (Backup-Filename)
$HTML_File_Path = "$($HTML_File_Dir)\EdgeBookmarks.html"
